// Minimuber number of deletion to make the langest palindrome
...
// form the original strings length...we will get the minumum number of deletions to make the 
...
int main()
{
   ...
   //string len=LCS(X,Y,m,n);
    cout<<"Minimum number of deletion to make Longest Palindromic Subsequence is: "<<m-LCS(X,Y,m,n)<<"\n";
    return 0;
}